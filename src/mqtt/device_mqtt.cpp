...
void AstarteDeviceMQTT::add_interface_from_json(const std::filesystem::path &json_file) {
...
auto AstarteDeviceMQTT::is_connected(const std::chrono::milliseconds &timeout) const -> bool {
