...
auto register_device(std::string_view pairing_jwt, std::string_view pairing_url,
  ...
  // TODO: perform validity check on the provided pairing_url
  // use [ada-url](https://www.ada-url.com/clients/cpp/)

  std::stringstream url;
  url << pairing_url << "/v1/" << realm << "/agent/devices";
  ...
  cpr::Response res = cpr::Post(cpr::Url{url.str()}, header, auth_token, cpr::Body{body.dump()},
