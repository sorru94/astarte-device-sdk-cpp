...
int main(int argc, char **argv) {
  ...
  msghub_client->add_interface_from_json(device_individual_interface_file_path, 0ms);
  ...
  msghub_client->add_interface_from_json(server_individual_interface_file_path, 0ms);
  ...
  msghub_client->add_interface_from_json(device_property_interface_file_path, 0ms);
  ...
  msghub_client->add_interface_from_json(device_aggregated_interface_file_path, 0ms);
  ...
  msghub_client->add_interface_from_json(server_aggregated_interface_file_path, 0ms);
  ...
  msghub_client->add_interface_from_json(server_property_interface_file_path, 0ms);
